...
export class ResultNotification<T = null> {
  ...
  static createError(message: string, key: string | null = null, code: number | null = null) {
...
export class DomainResultNotification<TData = null> extends ResultNotification<TData | null> {
